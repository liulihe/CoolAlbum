...
public class WeatherTest {
	...
	private String TIANQI_API_SECRET_KEY = "gvirbz9o9xun3s8q"; //

	private String TIANQI_API_USER_ID = "U636D686F4"; //
	...
	public static void main(String args[]) {
		WeatherTest demo = new WeatherTest();
		try {
			String url = demo.generateGetDiaryWeatherURL("沈丘", "zh-Hans", "c", "1", "1");
